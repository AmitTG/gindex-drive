...
function nav(path) {
    ...
    <a href="https://t.me/ByeAmit" target="_blank" class="mdui-btn mdui-btn-icon mdui-ripple mdui-ripple-white" mdui-tooltip="{content: 'GoIndex Drive on Github'}">
      <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 16 16" style="enable-background:new 0 0 489.003 489.003;margin-top: 6.3px;" class="bi bi-telegram" fill="currentColor" height="35" width="35">
